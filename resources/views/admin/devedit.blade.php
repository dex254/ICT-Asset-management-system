...
<head>
	...
	<title>Edit Device || KSG LRS</title>
</head>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Device Details</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
				  	...
				  	<div class="card-body p-4">
					  	...
					  	<hr/>
                       	<div class="form-body mt-4">
					    	<form class="row" action="{{ route('admin.devedit.update.post', $devices->id) }}" method="POST">
								@csrf
						   		<div class="col-lg-8">
                           			<div class="border border-3 p-4 rounded">
										<div class="mb-3">
											<label for="inputProductTitle" class="form-label">Device Model</label>
											<input type="text" class="form-control" name="model" id="inputProductTitle" placeholder="{{ $devices->model }}">
							  			</div>
							  			<div class="mb-3">
											<label for="inputProductDescription" class="form-label">Description</label>
											<textarea class="form-control" name="desc" id="inputProductDescription" rows="3">{{ $devices->desc }}</textarea>
							  			</div>
                            		</div>
						   		</div>
						   		<div class="col-lg-4">
									<div class="border border-3 p-4 rounded">
                              			<div class="row g-3">
                                              <div class="col-12">
												...
												<input type="text" class="form-control" name = "tag" id="inputPrice" placeholder= "{{ $devices->tag }}">
								  			</div>
								  			<div class="col-12">
								  			...
								  			<div class="col-12">
									  			<div class="d-grid">
                                         			<button type="submit" class="btn btn-light">Update Device</button>
									  			</div>
								  			</div>
							  			</div>
						  			</div>
