...
<head>
	...
	<title>Add New Staff || KSG LRS</title>
</head>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Add New Staff User</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    ...
                                    <div class="text-center mb-4">
                                        <h5 class="">KSG Staff Registration</h5>
                                        <p class="mb-0">Please fill the below details to create new staff account</p>
                                    </div>
                                    <div class="form-body">
                                        <form class="row g-3" action="{{ route('staff.add.store') }}" method="POST">
                                            @csrf
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12 text-center">
                                                <p class="mb-0">Does staff member already exist? <a href="/staff/Login">Sign in here.</a></p>
                                            </div>
                                        </form>
                                    </div>
                                </div>
