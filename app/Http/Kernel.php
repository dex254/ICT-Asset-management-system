...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'staff.auth' => \App\Http\Middleware\StaffMiddleware::class,
        'admin.auth' => \App\Http\Middleware\AdminMiddleware::class,
        'admin' => \App\Http\Middleware\ATableMiddleware::class,
        'device' => \App\Http\Middleware\DeviceMiddleware::class,
        'devrequest' => \App\Http\Middleware\DevrequestMiddleware::class,
